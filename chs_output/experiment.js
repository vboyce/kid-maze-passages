...
(() => {
  ...
  var PRACTICE_SENTENCES = [
    {
      ...
      instruction: `<h2>Let's try it together first!</h2><p>You'll see two words at a time. One belongs in the sentence \u2014 pick it!</p><p>Press <b>E</b> for the word on the left, <b>I</b> for the word on the right.</p><p>If you see "---" that's not a real word, so pick the other word!</p><img src="${IMAGE_BASE_URL}keyboard_hand.jpg" alt="Hands on a keyboard with E and I highlighted" style="width:70%;max-height:40vh;display:block;margin:16px auto;">`,
      word_tips: [
    ...
    },
    {
      ...
      instruction: `<h2>Your turn!</h2><p>Now you try it \u2014 pick the words that fit the sentence.</p><p>If you see "---" that's not a real word, so pick the other word!</p><p>If you need a hint, you can watch the sentence build up at the top as you go!</p>`
    },
    {
      level: 3,
  ...
  function createKeyLabels(display_element, trial_pars) {
    ...
    function badge(letter, align) {
      ...
      cell.innerHTML = `<kbd style="border:1px solid #bbb;border-radius:6px;padding:4px 14px;background:#f5f5f5;box-shadow:0 2px 0 #ccc">${letter}</kbd>`;
      return cell;
    }
  ...
  function buildExitSurvey() {
    return {
      ...
      preamble: "<h2>Before you go, we have a few quick questions!</h2> <p>Your responses will help us make our next study better.</p><p><b>Parents:</b> You can help your child type answers to these questions. All questions are optional.</p>",
      questions: [
        {
